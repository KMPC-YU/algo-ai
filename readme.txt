...
1.1.3. ALGo_food_recommendation.h5
  해당 파일은 식품 추천시스템 모델 파일이다.
1.2. Food Classification
1.2.1. ALGo_food_classification_train_code.ipynb
  해당 ipynb는 식품 분류 모델을 학습하는 파일이다.
1.2.2. ALGo_Food_Classfication.hdf5
  해당 파일은 식품 분류 모델 파일이다.
1.3. Hate_speech
1.2.1. ALGo_Hate_speech_train_train_code.ipynb
  해당 ipynb는 비속어 탐지 모델을 학습하는 파일이다.
1.2.2. ALGo_hate_speech_model.h5
  해당 파일은 비속어 탐지 모델 파일이다.
